...
SERVICES=  api-getaway telegram-service notification-service  auth-service media-service promo-service  game-service 
# payment-service  profile-service web-service  game-service
