...
SERVICES=  api-getaway  auth-service  telegram-service
#  payment-service  profile-service web-service  auth-service  media-service   game-service promo-service notification-service
