...
SERVICES=  api-getaway  auth-service media-service promo-service  game-service notification-service
# payment-service  profile-service web-service  game-service  notification-service telegram-service
