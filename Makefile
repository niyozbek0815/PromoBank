...
SERVICES=  api-getaway    auth-service media-service promo-service telegram-service   web-service  notification-service
# payment-service  profile-service   game-service
