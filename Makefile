...
SERVICES= api-getaway auth-service 
# promo-service game-service payment-service notification-service profile-service web-service media-service vote-service
