...
SERVICES=  api-getaway  promo-service auth-service media-service
# game-service payment-service notification-service profile-service web-service vote-service auth-service 
