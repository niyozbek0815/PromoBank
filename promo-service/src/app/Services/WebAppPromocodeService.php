...
class WebAppPromocodeService
{
    ...
    {
        $cacheKey = 'HasPromotion:telegram:' . $id;
    ...
    {
        $message = $this->promotionMessageRepository->getMessageForPromotion($promotionId, 'telegram', $type);
        return $message->getTranslation('message', $lang);
    }

    private function getPrizeMessage($prize, $lang): string
    {
        $message = $this->prizeMessageRepository->getMessageForPrize($prize->id, 'telegram', 'success');
