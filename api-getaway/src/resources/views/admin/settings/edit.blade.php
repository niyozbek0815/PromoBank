    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.filepond-image').forEach(input => {
                ...
                if (previewImg) {
                    pond.on('addfile', () => previewImg.style.display = 'none');
                    pond.on('removefile', () => previewImg.style.display = 'block');
                }
            });
        });
    </script>
...
<div class="card shadow-sm border-0">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-lg-6 mb-3">
                    <label class="form-label fw-bold">
                        Navbar logotipi <span class="text-danger">*</span>
                    </label>
                ...
                <div class="col-lg-6 mb-3">
                    <label class="form-label fw-bold">
                        Footer logotipi <span class="text-danger">*</span>
                    </label>
            ...
            {{-- Hero Title --}}
            <div class="row">
                @foreach(['uz'=>'O‘zbekcha','ru'=>'Ruscha','kr'=>'Krill','en'=>"English"] as $lang=>$label)
                    <div class="col-lg-3 mb-3">
                        <label class="form-label fw-bold">
                            Hero Title ({{ $label }}) <span class="text-danger">*</span>
                        </label>
                        <input type="text"
                               class="form-control"
                               name="hero_title[{{ $lang }}]"
                               required
            ...
            <div class="row">
                @foreach(['uz'=>'O‘zbekcha','ru'=>'Ruscha','kr'=>'Krill','en'=>"English"] as $lang=>$label)
                    <div class="col-lg-3 mb-3">
                        <label class="form-label fw-bold">
                            Footer Tavsifi ({{ $label }}) <span class="text-danger">*</span>
                        </label>
                        <input type="text"
                               class="form-control"
                               name="footer_description[{{ $lang }}]"
                               required
            ...
            <div class="row">
                @foreach(['uz'=>'O‘zbekcha','ru'=>'Ruscha','kr'=>'Krill','en'=>"English"] as $lang=>$label)
                    <div class="col-lg-3 mb-3">
                        <label class="form-label fw-bold">
                            Footer Pastki Qismi ({{ $label }}) <span class="text-danger">*</span>
                        </label>
                        <input type="text"
                               class="form-control"
                               name="footer_bottom[{{ $lang }}]"
                               required
            ...
            <div class="row">
                <div class="col-lg-6 mb-3">
                    <label class="form-label fw-bold">
                        Asosiy til <span class="text-danger">*</span>
                    </label>
