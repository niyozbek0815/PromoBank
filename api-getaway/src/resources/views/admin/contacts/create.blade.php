...
@section('title', "Yangi bog'lanish malumotlariqo'shish")
        ...
        <div class="tab-pane fade show active">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Yangi bog'lanish malumotlari qo'shish</h5>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('position')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Kontakt chiqarilish tartibi (0 = yuqorida)</small>
                                </div>
                            </div>
