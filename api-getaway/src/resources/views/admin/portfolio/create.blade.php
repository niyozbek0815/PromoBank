...
@section('title', "Yangi portfolio qo'shish")
        ...
        <div class="tab-pane fade show active">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Yangi portfolio qo'shish</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.portfolio.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <label class="form-label">Portfolio rasmi <span class="text-danger">*</span></label>
                                <input type="file" name="image" class="filepond-image" required
                                       data-max-file-size="2MB" accept="image/*" />
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    @error('position')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Portfolio ko‘rsatilish tartibi (0 = yuqorida)</small>
                                </div>

                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="is_featured" value="1"
                                               id="featuredSwitch" {{ old('is_featured') ? 'checked' : '' }}>
                                        <label class="form-check-label" for="featuredSwitch">
                                            <strong>Tanlangan portfolio</strong><br>
                                            <small class="text-muted">Belgilansa, alohida ajratib ko‘rsatiladi</small>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div class="form-check form-switch">
                                        ...
                                        <label class="form-check-label" for="statusSwitch">
                                            <strong>Faol portfolio</strong><br>
