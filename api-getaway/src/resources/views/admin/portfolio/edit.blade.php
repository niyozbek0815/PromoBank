...
@section('title', 'Portfolioni tahrirlash')
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (imageInput) {
                const pond = FilePond.create(imageInput, {
                    ...
                    labelIdle: 'Portfolio rasmini yuklang yoki tanlang',
                });
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Portfolioni tahrirlash</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.portfolio.update', $portfolio['id']) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    @foreach (['uz' => 'O‘zbekcha', 'ru' => 'Русский', 'kr' => 'Кириллча'] as $lang => $label)
                        <div class="col-lg-4 mb-3">
                            ...
                            <small class="text-muted">Portfolio sarlavhasini {{ $label }} tilida kiriting.</small>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="row">
                    @foreach (['uz' => 'O‘zbekcha', 'ru' => 'Русский', 'kr' => 'Кириллча'] as $lang => $label)
                        <div class="col-lg-4 mb-3">
                            ...
                            <small class="text-muted">Portfolio sub-sarlavhasi (ixtiyoriy)</small>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        <label class="form-label">Portfolio rasmi</label>
                        <input type="file" name="image" class="filepond-image" data-max-file-size="512KB" accept="image/*">

                        @if (!empty($portfolio['image']))
                            <div id="oldPreview" class="preview-container mt-3">
                                <img src="{{ asset($portfolio['image']) }}" alt="Portfolio Image" class="preview-img">
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="position"
                                   value="{{ old('position', $portfolio['position'] ?? 0) }}" min="0" required>
                            <small class="text-muted">Portfolio chiqarish tartibini belgilang.</small>
                        </div>
                        ...
                        <div class="mb-3 form-check form-switch">
                            ...
                            <label class="form-check-label" for="featuredSwitch">Tanlangan portfolio</label>
                        </div>
                        ...
                        <div class="mb-3 form-check form-switch">
                            ...
                            <input class="form-check-input" type="checkbox" name="status" value="1" id="statusSwitch"
                                   {{ old('status', $portfolio['status'] ?? 0) ? 'checked' : '' }}>
                ...
                <div class="d-flex justify-content-end gap-2 mt-3">
                    <a href="{{ route('admin.portfolio.index') }}" class="btn btn-outline-secondary">Bekor qilish</a>
