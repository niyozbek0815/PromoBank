        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu {{ request()->routeIs('admin.company.*') || request()->routeIs('admin.promotion.*') || request()->routeIs('admin.promocode.*') || request()->routeIs('admin.prize.*') || request()->routeIs('admin.promotion_shops.*') || request()->routeIs('admin.promotion_products.*') || request()->routeIs('admin.seles_receipts.*') || request()->routeIs('admin.socialcompany.*')  ? 'nav-item-open' : '' }}">
                    <a href="#" class="nav-link {{ request()->routeIs('admin.company.*') || request()->routeIs('admin.promotion.*') || request()->routeIs('admin.promocode.*') || request()->routeIs('admin.prize.*') || request()->routeIs('admin.promotion_shops.*') || request()->routeIs('admin.promotion_products.*') || request()->routeIs('admin.seles_receipts.*') ? 'active' : '' }}">
                    ...
                    <ul class="nav-group-sub collapse {{ request()->routeIs('admin.company.*') || request()->routeIs('admin.promotion.*') || request()->routeIs('admin.promocode.*') || request()->routeIs('admin.prize.*') || request()->routeIs('admin.promotion_shops.*') || request()->routeIs('admin.promotion_products.*') || request()->routeIs('admin.seles_receipts.*') || request()->routeIs('admin.socialcompany.*') ? 'show' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.promocode.index') }}" class="nav-link {{ request()->routeIs('admin.promocode.*') ? 'active' : '' }}">
                                <i class="ph-barcode"></i> Promocodelar
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.prize.index') }}" class="nav-link {{ request()->routeIs('admin.prize.*') ? 'active' : '' }}">
                                <i class="ph-gift"></i> Sovg'alar
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.promotion_shops.index') }}" class="nav-link {{ request()->routeIs('admin.promotion_shops.*') ? 'active' : '' }}">
                                <i class="ph-storefront"></i> Do‘konlar
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.promotion_products.index') }}" class="nav-link {{ request()->routeIs('admin.promotion_products.*') ? 'active' : '' }}">
                                <i class="ph-package"></i> Mahsulotlar
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.seles_receipts.index') }}" class="nav-link {{ request()->routeIs('admin.seles_receipts.*') ? 'active' : '' }}">
                ...
                {{-- Banner sozlamalari --}}
                <li class="nav-item nav-item-submenu {{ request()->routeIs('admin.banners.*') ? 'nav-item-open' : '' }}">
                ...
                {{-- Bildirishnomalar --}}
                <li class="nav-item nav-item-submenu {{ request()->routeIs('admin.notifications.*') ? 'nav-item-open' : '' }}">
                ...
                <li class="nav-item nav-item-submenu {{ request()->routeIs('admin.portfolio.*') || request()->routeIs('admin.sponsors.*') || request()->routeIs('admin.benefits.*') || request()->routeIs('admin.forsponsor.*') || request()->routeIs('admin.socials.*') || request()->routeIs('admin.downloads.*') || request()->routeIs('admin.contacts.*') || request()->routeIs('admin.abouts.*') || request()->routeIs('admin.settings.*') ? 'nav-item-open' : '' }}">
                    ...
                    <ul class="nav-group-sub collapse {{ request()->routeIs('admin.portfolio.*') || request()->routeIs('admin.sponsors.*') || request()->routeIs('admin.benefits.*') || request()->routeIs('admin.forsponsor.*') || request()->routeIs('admin.socials.*') || request()->routeIs('admin.downloads.*') || request()->routeIs('admin.contacts.*') || request()->routeIs('admin.abouts.*') || request()->routeIs('admin.settings.*') ? 'show' : '' }}">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.forsponsor.index') }}" class="nav-link {{ request()->routeIs('admin.forsponsor.*') ? 'active' : '' }}">
                                <i class="ph-medal"></i> Homiylar uchun
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.socials.index') }}" class="nav-link {{ request()->routeIs('admin.socials.*') ? 'active' : '' }}">
