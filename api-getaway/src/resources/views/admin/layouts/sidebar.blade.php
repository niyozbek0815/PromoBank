            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu">
                    ...
                    <ul class="nav-group-sub collapse">
                        ...
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_fixed_header.html"
                                class="nav-link">Fixed header</a></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_fixed_footer.html"
                                class="nav-link">Fixed footer</a></li>
                        <li class="nav-item-divider"></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_2_sidebars_1_side.html"
                                class="nav-link">2 sidebars on 1 side</a></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_2_sidebars_2_sides.html"
                                class="nav-link">2 sidebars on 2 sides</a></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_3_sidebars.html"
                                class="nav-link">3 sidebars</a></li>
                        <li class="nav-item-divider"></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_boxed_page.html"
                                class="nav-link">Boxed page</a></li>
                        <li class="nav-item"><a
                                href="https://themes.kopyov.com/limitless/demo/template/html/layout_1/seed/layout_boxed_content.html"
