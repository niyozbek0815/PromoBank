...
@section('title', "Yangi benefit qo'shish")
        ...
        <div class="tab-pane fade show active">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Yangi benefit qo'shish</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.benefits.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            @foreach (['uz' => 'O‘zbekcha', 'ru' => 'Русский', 'kr' => 'Кириллча','en'=>"English"] as $lang => $label)
                                <div class="col-lg-3 mb-3">
                                    ...
                                    <textarea name="description[{{ $lang }}]" rows="3"
                                    ...
                                    @error("description.$lang")
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Benefit tavsifini {{ $label }} tilida yozing</small>
                                </div>
                            @endforeach
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-3">
                                <label class="form-label">
                                    Benefit rasmi <span class="text-danger">*</span>
                                </label>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    @error('position')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">Benefit ko‘rsatilish tartibi (0 = yuqorida)</small>
                                </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('admin.benefits.index') }}" class="btn btn-outline-secondary">
